...
pytest tests/
```
Sources: [README.md:46-48](https://github.com/hexo-ai/dgm/blob/main/README.md#L46-L48), [README.md:78-78](https://github.com/hexo-ai/dgm/blob/main/README.md#L78)
...
graph TD
    ...
    A -.-> B
```
Sources: [tools/bash.py:1-100](https://github.com/hexo-ai/dgm/blob/main/tools/bash.py#L1-L100), [tests/test_bash_tool.py:1-50](https://github.com/hexo-ai/dgm/blob/main/tests/test_bash_tool.py#L1-L50)
...
graph LR
    ...
    E2 --> E3
```
Sources: [tools/edit.py:1-150](https://github.com/hexo-ai/dgm/blob/main/tools/edit.py#L1-L150), [tests/test_edit_tool.py:1-60](https://github.com/hexo-ai/dgm/blob/main/tests/test_edit_tool.py#L1-L60)
...
*   **`temp_git_repo`**: Creates a temporary directory and initializes a dummy Git repository. This is used by `test_edit_tool.py` to simulate the `git_tempdir` used by the `AgenticSystem` [coding_agent.py:71-71](https://github.com/hexo-ai/dgm/blob/main/coding_agent.py#L71).
...
Tests often utilize a specific `base_commit` to verify that tools like `get_current_edits` [coding_agent.py:94-96](https://github.com/hexo-ai/dgm/blob/main/coding_agent.py#L94-L96) correctly identify changes made during the test execution.
...
```
Sources: [tests/conftest.py:1-30](https://github.com/hexo-ai/dgm/blob/main/tests/conftest.py#L1-L30), [coding_agent.py:79-80](https://github.com/hexo-ai/dgm/blob/main/coding_agent.py#L79-L80)

---

## Integration with AgenticSystem

While `tests/` focuses on individual tools, these components are the building blocks for the `AgenticSystem.forward()` method [coding_agent.py:153-169](https://github.com/hexo-ai/dgm/blob/main/coding_agent.py#L153-L169). 

1.  **Tool Loading**: The `AgenticSystem` initializes tools via `llm_withtools.py`, which relies on the logic validated in `tests/`.
2.  **Execution Loop**: The `chat_with_agent` loop [llm_withtools.py:9-9](https://github.com/hexo-ai/dgm/blob/main/llm_withtools.py#L9) dispatches calls to `BashSession` and `edit_tool`. If the tests in `tests/` fail, the entire self-improvement loop in `DGM_outer.py` [DGM_outer.py:67-68](https://github.com/hexo-ai/dgm/blob/main/DGM_outer.py#L67-L68) is compromised.

Sources: [coding_agent.py:153-169](https://github.com/hexo-ai/dgm/blob/main/coding_agent.py#L153-L169), [llm_withtools.py:1-20](https://github.com/hexo-ai/dgm/blob/main/llm_withtools.py#L1-L20), [DGM_outer.py:67-68](https://github.com/hexo-ai/dgm/blob/main/DGM_outer.py#L67-L68)
