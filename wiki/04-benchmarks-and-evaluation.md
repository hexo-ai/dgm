...
Evaluation results serve as the "fitness function" for the DGM. When the `DGM_outer.py` script orchestrates a generation, it triggers evaluation runs for new candidate agents. The results are aggregated into a `metadata.json` file within each candidate's directory, containing scores such as `accuracy_score`, `total_resolved_ids`, and `total_unresolved_ids` [DGM_outer.py:61-66](https://github.com/hexo-ai/dgm/blob/main/DGM_outer.py#L61-L66).

These metrics flow back into the selection logic in `choose_selfimproves`, where they influence which commits are chosen as parents for the next generation based on methods like `score_prop` (proportional to score) or `best` [DGM_outer.py:83-106](https://github.com/hexo-ai/dgm/blob/main/DGM_outer.py#L83-L106).
...
```
Sources: [DGM_outer.py:50-110](https://github.com/hexo-ai/dgm/blob/main/DGM_outer.py#L50-L110), [README.md:71-81](https://github.com/hexo-ai/dgm/blob/main/README.md#L71-L81)
...
DGM includes baseline evaluation artifacts in the `initial/` directory, which serve as the starting point for evolution [DGM_outer.py:28-31](https://github.com/hexo-ai/dgm/blob/main/DGM_outer.py#L28-L31).

For details, see [SWE-bench Integration (swe_bench/)](04.1-swe-bench-integration.md).

**Sources:** [DGM_outer.py:28-33](https://github.com/hexo-ai/dgm/blob/main/DGM_outer.py#L28-L33), [README.md:52-58](https://github.com/hexo-ai/dgm/blob/main/README.md#L52-L58), [README.md:75](https://github.com/hexo-ai/dgm/blob/main/README.md)
...
*   **Dataset Preparation**: Using `polyglot/prepare_polyglot_dataset.py` to configure CMake and extract metadata [README.md:60-63](https://github.com/hexo-ai/dgm/blob/main/README.md#L60-L63).
...
The initial performance for this track is stored in `initial_polyglot/` [DGM_outer.py:28](https://github.com/hexo-ai/dgm/blob/main/DGM_outer.py).

For details, see [Polyglot Benchmark Integration (polyglot/)](04.2-polyglot-benchmark.md).

**Sources:** [DGM_outer.py:28-31](https://github.com/hexo-ai/dgm/blob/main/DGM_outer.py#L28-L31), [README.md:60-63](https://github.com/hexo-ai/dgm/blob/main/README.md#L60-L63), [README.md:76](https://github.com/hexo-ai/dgm/blob/main/README.md)
...
```
Sources: [DGM_outer.py:60-66](https://github.com/hexo-ai/dgm/blob/main/DGM_outer.py#L60-L66), [README.md:71-81](https://github.com/hexo-ai/dgm/blob/main/README.md#L71-L81)
...
**Sources:** [README.md:71-81](https://github.com/hexo-ai/dgm/blob/main/README.md#L71-L81), [DGM_outer.py:15-35](https://github.com/hexo-ai/dgm/blob/main/DGM_outer.py#L15-L35)
